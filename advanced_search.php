...
<div class="container_24" id="container">
  ...
  <div id="page_topic">
   ...
   <!-- start -->
   <form action="search.php" method="get" enctype="multipart/form-data" name="listing-form" class="form-horizontal" onSubmit="map_geocode( this.address.value ); return false;">
