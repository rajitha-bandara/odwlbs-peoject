...
<div class="container_24" id="container">
  ...
  <div class="grid_17">
    <div id="listing_wrapper" class="grid_17">
      ...
      <div class="grid_17" id="listing_share_bar">
        ...
        <div id="share_in" class="grid_3"> <a href="javascript:bookmark('window.location.href','<?php echo $title;?>, - <?php echo DOMAIN_NAME;?>');"><img src="public/img/social/bookmark.png" width="16" height="16" alt="Add to Bookmarks" title="Bookmark"></a>
          <script src="http://cdn.printfriendly.com/printfriendly.js" type="text/javascript"></script>
          <a href="http://www.printfriendly.com"  class="printfriendly" onclick="window.print(); return false;" title="Print"><img src="http://cdn.printfriendly.com/pf-print-icon.gif" alt="Print"/></a> <a href="http://www.printfriendly.com" class="printfriendly" onclick="window.print(); return false;" title="PDF"> <img  src="http://cdn.printfriendly.com/pf-pdf-icon.gif" alt="PDF"/></a> </div>
      </div>
      ...
      <div class="grid_17" id="listing_general">
        <div class="grid_10">
          ...
          <div id="category">
            <ul>
              <?php echo formatSubCategory($mainCatId,$mainCategory,$subCatId,$subCategory);?> <?php echo formatCategory($mainCatId,$mainCategory);?>
            </ul>
          </div>
          <div id="rating" >
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(po, s);
          ...
          <div id="web" <?php if($package == 'b'){?> style="display:none" <?php }?>> <a href="<?php echo $web;?>" target="_blank">Visit Web Site</a> </div>
        </div>
        <div class="grid_7" id="logo"> <?php echo $logo;?> </div>
      </div>
      <hr class="grid_17">
      <div id="contacts" class="grid_17">
        ...
        <ul>
          ...
          <li class="grid_2">
            <div id="follow" <?php if($package == 'b'){?> style="display:none" <?php }?>><a href=""><img src="public/img/social/facebook.png" width="32" height="32" alt="Find us on Facebook"></a></div>
          </li>
          <li class="grid_2">
            <div id="follow" <?php if($package == 'b'){?> style="display:none" <?php }?>><a href=""><img src="public/img/social/twitter.png" width="32" height="32" alt="Find us on Facebook"></a></div>
          </li>
        </ul>
      </div>
      <hr class="grid_17">
      ...
      <div id="media" class="grid_17">
        ...
        <?php echo $thumb;?>
        <div class="grid_17">
          <div id="see_more" <?php if($images==null){?> style="display:none" <?php }?>> <a id="fancybox-manual-c" href="javascript:;">See more >></a> </div>
          <div id="see_more" <?php if($images==null){?> style="display:none" <?php }?>> <a class="fancybox-media" href="http://www.youtube.com/watch?v=opj24KnzrWo">Watch Video</a> </div>
        </div>
      </div>
      <hr class="grid_17">
      <div id="location" class="grid_17">
        ...
        <div class="grid_17"> <a  
onclick="javascript:window.open('http://zms.zhiing.com/webclient/zhiingchat/zmschat2.aspx?addrTxt=<?php echo $street.", ".$city. ", ".$country; ?>&txtFrom=<?php echo DOMAIN_NAME;?>&txtSubject=<?php echo $title;?>&txtMessage=<?php echo "Received location details for ".$title;?>','zhiing','resizable=no,scrollbars=no,height=436,width=568,status=yes');"> <img src='http://images.zoscomm.com/buttonv2.png' alt='Send to Phone' style='cursor: pointer' /> </a> </div>
      </div>
      <hr class="grid_17">
  ...
  <div class="grid_6" id="listing_sec_col">
    ...
    <div id="large_map_link" <?php if($package == 'b'){?> style="display:none" <?php }?>><a href="map_large.php?lat=<?php echo $latitude;?>&lon=<?php echo $longitude;?>&lid=<?php echo $lid;?>&title=<?php echo $safeTitle;?>">View Large Map</a></div>
    
    <div id="map" <?php if($package == 'b'){?> style="display:none; padding-top:50px;" <?php }?>></div>
