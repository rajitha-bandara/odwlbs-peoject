...
<meta name="description" content="Listing directions <?php echo DOMAIN_NAME;?>" />
<meta name="keywords" content="Driving directions for <?php echo $title;?>">
<!-- Le styles -->
    ...
    <div class="grid_17" id="main_wrapper">
      ...
      <div class="grid_17" id="page_content">
        <div id="dir_general">
          <ul>
            <li id="title">
              <h1><a href="<?php echo SITE_URL;?>/listing/<?php echo $safeTitle;?>-<?php echo $lid;?>.html"><?php echo $title;?></a></h1>
            </li>
