<ul id="VerColMenu">
	...
	<li><a href="#">Listing Details</a>
		<ul>
            ...
            <li><a  href="iedit_social_links.php?lid=<?php echo $lid;?>" target="edit_listing_view" onClick="window.open('iedit_social_links.php?lid=<?php echo $lid;?>','edit_listing_view');" oncontextmenu="return false;">Social Links</a></li>
		</ul>
	</li>
	...
	<li><a  href="#" oncontextmenu="return false;">Banners</a>
		<ul>
			<li><a  href="iedit_banners.php?lid=<?php echo $lid;?>" target="edit_listing_view" onClick="window.open('iedit_banners.php?lid=<?php echo $lid;?>','edit_listing_view');" oncontextmenu="return false;">Manage</a></li>
			<li><a href="#">Add</a></li>
		</ul>
	</li>
