...
<html lang="en">
<head>
<title><?php echo DOMAIN_NAME;?> :: Reset Password</title>
<meta charset="utf-8">
...
<div class="container_24" id="container">
  ...
  <div id="page_content" class="grid_24" style="background-color:#FFF;">
    <div id="page_topic">
      <h1>Reset Your Password</h1>
    </div>
    <div  id="response"> <?php echo $outputForUser;?> </div>
    <div id="forgot_password_model" align="center">
      <p>No problem! Give us the email address you registered with and we'll send you instructions on how to reset your password. </p>
      <br>
      <br>
      <br>
      <form method="post" action="" class="form-horizontal">
        Email
        <input type="text" name="txtforgotpass" class="input-large">
