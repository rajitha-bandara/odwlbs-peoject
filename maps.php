...
<div class="container_24" id="container">
  ...
  <ul class="">
  <li>
  <input name="rbPlaceType" type="radio" value="airport" /> Airport
  </li>
  <li>
  <input name="rbPlaceType" type="radio" value="bank" /> Bank
  </li>
  <li>
  <input name="rbPlaceType" type="radio" value="casino" /> Casino
  </li>
   <li>
  <input name="rbPlaceType" type="radio" value="food" /> Food
  </li>
   <li>
  <input name="rbPlaceType" type="radio" value="hospital" /> Hospital
  </li>
  <li>
  <input name="rbPlaceType" type="radio" value="pharmacy" /> Pharmacy
  </li>
   <li>
  <input name="rbPlaceType" type="radio" value="Food" /> Travel Agency
  </li>
   <li>
