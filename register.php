...
<html lang="en">
<head>
<title><?php echo DOMAIN_NAME;?>:: New Member</title>
<meta charset="utf-8">
      ...
      <div id="reg-form">
        <form action="" method="post" class="form-horizontal" id="reg_form" name="reg_form">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="checkbox" name="cbAccept" id="cbAccept" onChange="checkTerms()" value="I have read and accept Places.com Conditions of use.">
              I have read and accept Places.com <a href="terms.php" target="_blank">Terms of use</a>. <br>
              <input type="checkbox" name="cbUpdates" id="cbUpdates"  value="Receive updates and notifications via Email.">
              Receive updates and notifications via Email. </div>
          </div>
          <div class="control-group">
            <div class="controls">
